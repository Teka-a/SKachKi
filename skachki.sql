...
CREATE TABLE public.c_u_h (
    id integer NOT NULL,
    chip_time time without time zone NOT NULL,
...
COPY public.contests (id, name, date, "time", hippodrome_id, status) FROM stdin;
1	First place	2024-08-13	04:05:00	1	open
2	Go, Horse, go!	2023-10-08	16:00:00	1	closed
\.
...
COPY public.horses (id, name, sex, age, owner_id) FROM stdin;
1	star	filly	4	2
2	snowy	filly	3	2
\.
...
SELECT pg_catalog.setval('public.c_u_h_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.contests_id_seq', 2, true);
...
--
-- Name: c_u_h c_u_h_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.c_u_h
    ADD CONSTRAINT c_u_h_pkey PRIMARY KEY (id);
